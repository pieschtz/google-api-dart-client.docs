...
Isolate.$defineClass("LinkedHashMapImplementation", "Object", ["_map", "_lib_list"], {
 toString$0: function() {
  return $.mapToString(this);
 },
 clear$0: function() {
 ...
 forEach$1: function(f) {
  var t1 = ({});
  t1.f_16 = f;
  $.forEach(this._lib_list, new $.Closure21(t1));
 },
 getKeys$0: function() {
  var t1 = ({});
  var list = $.List($.get$length(this));
  ...
  t1.list_12 = list;
  t1.index_2 = 0;
  $.forEach(this._lib_list, new $.Closure28(t1));
 ...
 operator$indexSet$2: function(key, value) {
  if (this._map.containsKey$1(key) === true) {
    ...
    $.addLast(this._lib_list, $.KeyValuePair$2(key, value));
...
Isolate.$defineClass("Closure30", "Object", [], {
 toString$0: function() {
  return 'Closure';
 }
});
...
Isolate.$defineClass("ConstantMap", "Object", ["_lib4_keys?", "_jsObject", "length?"], {
 ...
 forEach$1: function(f) {
  var t1 = ({});
  t1.f_14 = f;
  $.forEach(this._lib4_keys, new $.Closure17(this, t1));
 },
 operator$index$1: function(key) {
...
Isolate.$defineClass("_FrozenElementListIterator", "Object", ["_lib2_index", "_list"], {
 hasNext$0: function() {
  return $.lt(this._lib2_index, $.get$length(this._list));
 },
 next$0: function() {
  if (this.hasNext$0() !== true) {
    throw $.captureStackTrace($.CTC3);
...
Isolate.$defineClass("Token", "Object", ["end", "start", "source", "kind?"], {
 toString$0: function() {
  var kindText = $.kindToString(this.kind);
  var actualText = this.get$text();
  if (!$.eqB(kindText, actualText)) {
    if ($.gtB($.get$length(actualText), 10)) {
      actualText = $.add($.substring$2(actualText, 0, 8), '...');
    }
...
Isolate.$defineClass("LiteralToken", "Token", ["value=", "end", "start", "source", "kind"], {
});

Isolate.$defineClass("ErrorToken", "Token", ["message", "end", "start", "source", "kind"], {
});

Isolate.$defineClass("SourceFile", "Object", ["_lineStarts", "orderInLibrary?", "_text", "filename?"], {
 compareTo$1: function(other) {
  if (!$.eqNullB(this.orderInLibrary) && !$.eqNullB(other.get$orderInLibrary())) {
    return $.sub(this.orderInLibrary, other.get$orderInLibrary());
  } else {
...
Isolate.$defineClass("InterpStack", "Object", ["depth=", "isMultiline?", "quote?", "previous", "next"], {
 pop$0: function() {
...
Isolate.$defineClass("TokenizerBase", "TokenizerHelpers", [], {
 finishIdentifier$1: function(ch) {
  if (!$.eqNullB(this._interpStack) && $.eqB(this._interpStack.get$depth(), -1)) {
    ...
    if ($.eqB(ch, 36)) {
      return this._errorToken$1('illegal character after $ in string interpolation');
    }
    for (; $.ltB(this._lib3_index, $.get$length(this._text)); ) {
      var t1 = this._text;
      var t2 = this._lib3_index;
      this._lib3_index = $.add(t2, 1);
      if ($.isInterpIdentifierPart($.charCodeAt(t1, t2)) !== true) {
        this._lib3_index = $.sub(this._lib3_index, 1);
        break;
      }
    }
  } else {
  ...
  var ch = this._nextChar$0();
    ...
    case 117:
      if (this._maybeEatChar$1(123) === true) {
        ...
        if (this._maybeEatChar$1(125) !== true) {
          return -1;
        } else {
          break;
        }
 ...
 finishStringBody$1: function(quote) {
  ...
  for (; true; ) {
    var ch = this._nextChar$0();
    if ($.eqB(ch, quote)) {
      return this._makeStringToken$2(buf, false);
    } else {
      if ($.eqB(ch, 36)) {
        ...
        if ($.eqB(ch, 0)) {
          ...
          if ($.eqB(ch, 92)) {
            ...
            if ($.eqB(escapeVal, -1)) {
              return this._errorToken$1('invalid hex escape sequence');
            } else {
              buf.push(escapeVal);
            }
          } else {
 ...
 finishMultilineRawString$1: function(quote) {
  for (; true; ) {
    ...
    if ($.eqB(ch, 0)) {
      ...
      if ($.eqB(ch, quote) && this._maybeEatChar$1(quote) === true && this._maybeEatChar$1(quote) === true) {
        return this._makeRawStringToken$1(true);
      }
    }
  }
 },
 finishRawString$1: function(quote) {
  if (this._maybeEatChar$1(quote) === true) {
    if (this._maybeEatChar$1(quote) === true) {
      return this.finishMultilineRawString$1(quote);
    } else {
  ...
  for (; true; ) {
    var ch = this._nextChar$0();
    if ($.eqB(ch, quote)) {
      return this._makeRawStringToken$1(false);
    } else {
      if ($.eqB(ch, 0)) {
        return this._errorToken$0();
      }
 ...
 _finishCloseBrace$0: function() {
  if (!$.eqNullB(this._interpStack)) {
    ...
    $.assert($.ge(this._interpStack.get$depth(), 0));
  }
  return this._finishToken$1(7);
 },
 _finishOpenBrace$0: function() {
  if (!$.eqNullB(this._interpStack)) {
    if ($.eqB(this._interpStack.get$depth(), -1)) {
      this._interpStack.set$depth(1);
    } else {
      $.assert($.ge(this._interpStack.get$depth(), 0));
      var t1 = this._interpStack;
 ...
 _makeRawStringToken$1: function(isMultiline) {
  if (isMultiline === true) {
    ...
    var s = $.substring$2(t1.get$text(), start, $.sub(this._lib3_index, 3));
  } else {
    s = $.substring$2(this._source.get$text(), $.add(this._startIndex, 2), $.sub(this._lib3_index, 1));
  }
  return $.LiteralToken$5(58, this._source, this._startIndex, this._lib3_index, s);
 },
 _makeStringToken$2: function(buf, isPart) {
  ...
  return $.LiteralToken$5(kind, this._source, this._startIndex, this._lib3_index, s);
 },
 ...
 finishHex$0: function() {
  ...
  return $.LiteralToken$5(61, this._source, this._startIndex, this._lib3_index, value);
 },
 readHex$1: function(hexLength) {
  var t1 = hexLength === (void 0);
  if (t1) {
    var maxIndex = $.sub($.get$length(this._text), 1);
  } else {
    maxIndex = $.add(this._lib3_index, hexLength);
    if ($.geB(maxIndex, $.get$length(this._text))) {
      return -1;
    }
  }
  if (typeof maxIndex !== 'number') return this.readHex$1$bailout(hexLength, 1, t1, maxIndex);
  for (var result = 0; $.ltB(this._lib3_index, maxIndex); ) {
    var digit = $._hexDigit($.charCodeAt(this._text, this._lib3_index));
    if ($.eqB(digit, -1)) {
      if (t1) {
        return result;
      } else {
    ...
    $._hexDigit($.charCodeAt(this._text, this._lib3_index));
    result = $.add(result * 16, digit);
    this._lib3_index = $.add(this._lib3_index, 1);
  }
  return result;
 },
 readHex$1$bailout: function(hexLength, state, env0, env1) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      var result = 0;
      L0: while (true) {
        if (!$.ltB(this._lib3_index, maxIndex)) break L0;
        var digit = $._hexDigit($.charCodeAt(this._text, this._lib3_index));
        if ($.eqB(digit, -1)) {
          if (t1) {
            return result;
 ...
 eatDigits$0: function() {
  for (; $.ltB(this._lib3_index, $.get$length(this._text)); ) {
    if ($.isDigit($.charCodeAt(this._text, this._lib3_index)) === true) {
      this._lib3_index = $.add(this._lib3_index, 1);
    } else {
      return;
    }
  ...
  do {
    ...
    if ($.eqB(ch, 0)) {
      ...
      if ($.eqB(ch, 42)) {
        ...
        if ($.eqB(ch, 47)) {
          if (this._maybeEatChar$1(42) === true) {
            ++nesting;
          }
        }
      }
 ...
 finishHashBang$0: function() {
  for (; true; ) {
    var ch = this._nextChar$0();
    if ($.eqB(ch, 0) || $.eqB(ch, 10) || $.eqB(ch, 13)) {
      return this._finishToken$1(13);
    }
  }
 },
 finishWhitespace$0: function() {
  this._lib3_index = $.sub(this._lib3_index, 1);
  for (var t1 = this._skipWhitespace === true, t2 = !t1; $.ltB(this._lib3_index, $.get$length(this._text)); ) {
    var t3 = this._text;
    var t4 = this._lib3_index;
    this._lib3_index = $.add(t4, 1);
 ...
 _errorToken$1: function(message) {
  return $.ErrorToken$5(65, this._source, this._startIndex, this._lib3_index, message);
 },
 ...
 _finishToken$1: function(kind) {
  return $.Token$4(kind, this._source, this._startIndex, this._lib3_index);
 },
 _maybeEatChar$1: function(ch) {
  if ($.ltB(this._lib3_index, $.get$length(this._text))) {
    if ($.eqB($.charCodeAt(this._text, this._lib3_index), ch)) {
      this._lib3_index = $.add(this._lib3_index, 1);
      return true;
    } else {
      return false;
 ...
 _peekChar$0: function() {
  if ($.ltB(this._lib3_index, $.get$length(this._text))) {
    return $.charCodeAt(this._text, this._lib3_index);
  } else {
    return 0;
  }
 },
...
Isolate.$defineClass("Tokenizer", "TokenizerBase", ["_interpStack", "_startIndex", "_lib3_index", "_text", "_skipWhitespace", "_source"], {
 getIdentifierKind$0: function() {
  var i0 = this._startIndex;
    switch ($.sub(this._lib3_index, i0)) {
    case 2:
      var ch = $.charCodeAt(this._text, i0);
      if ($.eqB(ch, 100)) {
        if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 111)) {
          return 95;
        }
      } else {
        if ($.eqB(ch, 105)) {
    ...
    case 3:
      ...
      if ($.eqB(ch, 102)) {
        if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 111) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 114)) {
          return 101;
        }
      } else {
        if ($.eqB(ch, 103)) {
          if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 116)) {
            return 75;
          }
        } else {
          if ($.eqB(ch, 110)) {
            if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 119)) {
              return 105;
            }
          } else {
            if ($.eqB(ch, 115)) {
              ...
              if ($.eqB(ch, 116)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 121)) {
                  return 113;
                }
              } else {
                if ($.eqB(ch, 118)) {
                  if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 114)) {
                    return 114;
                  }
                }
              }
    ...
    case 4:
      ...
      if ($.eqB(ch, 99)) {
        if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 97)) {
          ...
          if ($.eqB(ch, 108)) {
            if ($.eqB($.charCodeAt(this._text, $.add(i0, 3)), 108)) {
              return 73;
            }
          } else {
            if ($.eqB(ch, 115)) {
              if ($.eqB($.charCodeAt(this._text, $.add(i0, 3)), 101)) {
                return 89;
              }
            }
          }
        ...
        if ($.eqB(ch, 101)) {
          if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 108) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 115) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 101)) {
            return 96;
          }
        } else {
          if ($.eqB(ch, 110)) {
            if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 117) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 108) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 108)) {
              return 106;
            }
          } else {
            if ($.eqB(ch, 116)) {
              ch = $.charCodeAt(this._text, $.add(i0, 1));
              if ($.eqB(ch, 104)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 115)) {
                  return 110;
                }
              } else {
                if ($.eqB(ch, 114)) {
                  if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 117) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 101)) {
                    return 112;
                  }
                }
              }
              ...
              if ($.eqB(ch, 118)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 111) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 100)) {
                  return 115;
                }
              }
            }
    ...
    case 5:
      ch = $.charCodeAt(this._text, i0);
      if ($.eqB(ch, 97)) {
        if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 119) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 116)) {
          return 87;
        }
      } else {
        if ($.eqB(ch, 98)) {
          if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 107)) {
            return 88;
          }
        } else {
          if ($.eqB(ch, 99)) {
            ch = $.charCodeAt(this._text, $.add(i0, 1));
            if ($.eqB(ch, 97)) {
              if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 99) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 104)) {
                return 90;
              }
            } else {
              if ($.eqB(ch, 108)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 115) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 115)) {
                  return 91;
                }
              } else {
                if ($.eqB(ch, 111)) {
                  if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 110) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 115) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 116)) {
                    return 92;
                  }
                }
              }
            ...
            if ($.eqB(ch, 102)) {
              ch = $.charCodeAt(this._text, $.add(i0, 1));
              if ($.eqB(ch, 97)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 108) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 115) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 101)) {
                  return 98;
                }
              } else {
                if ($.eqB(ch, 105)) {
                  if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 110) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 108)) {
                    return 99;
                  }
                }
              }
              ...
              if ($.eqB(ch, 115)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 117) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 112) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 114)) {
                  return 108;
                }
              } else {
                if ($.eqB(ch, 116)) {
                  if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 104) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 111) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 119)) {
                    return 111;
                  }
                } else {
                  if ($.eqB(ch, 119)) {
                    if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 104) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 108) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 101)) {
                      return 116;
                    }
                  }
                }
    ...
    case 6:
      ch = $.charCodeAt(this._text, i0);
      if ($.eqB(ch, 97)) {
        if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 115) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 115) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 116)) {
          return 72;
        }
      } else {
        if ($.eqB(ch, 105)) {
          if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 109) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 112) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 111) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 116)) {
            return 77;
          }
        } else {
          if ($.eqB(ch, 110)) {
            ch = $.charCodeAt(this._text, $.add(i0, 1));
            if ($.eqB(ch, 97)) {
              if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 118) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 101)) {
                return 80;
              }
            } else {
              if ($.eqB(ch, 101)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 103) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 101)) {
                  return 81;
                }
              }
            }
            ...
            if ($.eqB(ch, 114)) {
              if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 117) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 110)) {
                return 107;
              }
            } else {
              if ($.eqB(ch, 115)) {
                ch = $.charCodeAt(this._text, $.add(i0, 1));
                if ($.eqB(ch, 111)) {
                  if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 117) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 99) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 101)) {
                    return 84;
                  }
                } else {
                  if ($.eqB(ch, 116)) {
                    if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 99)) {
                      return 85;
                    }
                  } else {
                    if ($.eqB(ch, 119)) {
                      if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 99) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 104)) {
                        return 109;
                      }
                    }
                  }
    ...
    case 7:
      ch = $.charCodeAt(this._text, i0);
      if ($.eqB(ch, 100)) {
        if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 102) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 117) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 108) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 116)) {
          return 94;
        }
      } else {
        if ($.eqB(ch, 101)) {
          if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 120) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 110) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 100) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 115)) {
            return 97;
          }
        } else {
          if ($.eqB(ch, 102)) {
            ch = $.charCodeAt(this._text, $.add(i0, 1));
            if ($.eqB(ch, 97)) {
              if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 99) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 111) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 121)) {
                return 74;
              }
            } else {
              if ($.eqB(ch, 105)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 2)), 110) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 108) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 108) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 121)) {
                  return 100;
                }
              }
            }
            ...
            if ($.eqB(ch, 108)) {
              if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 98) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 121)) {
                return 79;
              }
            } else {
              if ($.eqB(ch, 116)) {
                if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 121) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 112) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 100) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 102)) {
                  return 86;
                }
              }
            }
    ...
    case 8:
      ch = $.charCodeAt(this._text, i0);
      if ($.eqB(ch, 97)) {
        if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 98) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 115) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 99) && $.eqB($.charCodeAt(this._text, $.add(i0, 7)), 116)) {
          return 71;
        }
      } else {
        if ($.eqB(ch, 99)) {
          if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 111) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 110) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 110) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 117) && $.eqB($.charCodeAt(this._text, $.add(i0, 7)), 101)) {
            return 93;
          }
        } else {
          if ($.eqB(ch, 111)) {
            if ($.eqB($.charCodeAt(this._text, $.add(i0, 1)), 112) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 111) && $.eqB($.charCodeAt(this._text, $.add(i0, 7)), 114)) {
              return 82;
            }
          }
        }
      ...
      return 70;
    case 9:
      if ($.eqB($.charCodeAt(this._text, i0), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 1)), 110) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 114) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 102) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 97) && $.eqB($.charCodeAt(this._text, $.add(i0, 7)), 99) && $.eqB($.charCodeAt(this._text, $.add(i0, 8)), 101)) {
        return 78;
      }
      return 70;
    case 10:
      if ($.eqB($.charCodeAt(this._text, i0), 105) && $.eqB($.charCodeAt(this._text, $.add(i0, 1)), 109) && $.eqB($.charCodeAt(this._text, $.add(i0, 2)), 112) && $.eqB($.charCodeAt(this._text, $.add(i0, 3)), 108) && $.eqB($.charCodeAt(this._text, $.add(i0, 4)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 5)), 109) && $.eqB($.charCodeAt(this._text, $.add(i0, 6)), 101) && $.eqB($.charCodeAt(this._text, $.add(i0, 7)), 110) && $.eqB($.charCodeAt(this._text, $.add(i0, 8)), 116) && $.eqB($.charCodeAt(this._text, $.add(i0, 9)), 115)) {
        return 76;
      }
      return 70;
    default:
 ...
 next$0: function() {
  this._startIndex = this._lib3_index;
  if (!$.eqNullB(this._interpStack) && $.eqB(this._interpStack.get$depth(), 0)) {
    ...
    if (istack.get$isMultiline() === true) {
      return this.finishMultilineString$1(istack.get$quote());
    } else {
  ...
  var ch = this._nextChar$0();
    ...
    case 35:
      if (this._maybeEatChar$1(33) === true) {
        return this.finishHashBang$0();
      } else {
        return this._finishToken$1(12);
      }
    case 36:
      if (this._maybeEatChar$1(34) === true) {
        return this.finishString$1(34);
      } else {
        if (this._maybeEatChar$1(39) === true) {
    ...
    case 37:
      if (this._maybeEatChar$1(61) === true) {
        return this._finishToken$1(32);
      } else {
        return this._finishToken$1(47);
      }
    case 38:
      if (this._maybeEatChar$1(38) === true) {
        return this._finishToken$1(35);
      } else {
        if (this._maybeEatChar$1(61) === true) {
          return this._finishToken$1(23);
        } else {
    ...
    case 42:
      if (this._maybeEatChar$1(61) === true) {
        return this._finishToken$1(29);
      } else {
        return this._finishToken$1(44);
      }
    case 43:
      if (this._maybeEatChar$1(43) === true) {
        return this._finishToken$1(16);
      } else {
        if (this._maybeEatChar$1(61) === true) {
          return this._finishToken$1(27);
        } else {
    ...
    case 45:
      if (this._maybeEatChar$1(45) === true) {
        return this._finishToken$1(17);
      } else {
        if (this._maybeEatChar$1(61) === true) {
          return this._finishToken$1(28);
        } else {
    ...
    case 47:
      if (this._maybeEatChar$1(42) === true) {
        ...
        if (this._maybeEatChar$1(47) === true) {
          return this.finishSingleLineComment$0();
        } else {
          if (this._maybeEatChar$1(61) === true) {
            return this._finishToken$1(30);
          } else {
    ...
    case 48:
      if (this._maybeEatChar$1(88) === true) {
        return this.finishHex$0();
      } else {
        if (this._maybeEatChar$1(120) === true) {
          return this.finishHex$0();
        } else {
    ...
    case 60:
      if (this._maybeEatChar$1(60) === true) {
        if (this._maybeEatChar$1(61) === true) {
          return this._finishToken$1(24);
        } else {
          return this._finishToken$1(39);
        }
      } else {
        if (this._maybeEatChar$1(61) === true) {
          return this._finishToken$1(54);
        } else {
    ...
    case 62:
      if (this._maybeEatChar$1(61) === true) {
        return this._finishToken$1(55);
      } else {
        if (this._maybeEatChar$1(62) === true) {
          if (this._maybeEatChar$1(61) === true) {
            return this._finishToken$1(25);
          } else {
            if (this._maybeEatChar$1(62) === true) {
              if (this._maybeEatChar$1(61) === true) {
                return this._finishToken$1(26);
              } else {
    ...
    case 64:
      if (this._maybeEatChar$1(34) === true) {
        return this.finishRawString$1(34);
      } else {
        if (this._maybeEatChar$1(39) === true) {
          return this.finishRawString$1(39);
        } else {
          return this._errorToken$0();
        }
      }
    ...
    case 124:
      if (this._maybeEatChar$1(61) === true) {
        return this._finishToken$1(21);
      } else {
        if (this._maybeEatChar$1(124) === true) {
          return this._finishToken$1(34);
        } else {
    ...
    default:
      if ($.isIdentifierStart(ch) === true) {
        return this.finishIdentifier$1(ch);
      } else {
        if ($.isDigit(ch) === true) {
          return this.finishNumber$0();
        } else {
...
Isolate.$defineClass("TokenizerHelpers", "Object", [], {
});

Isolate.$defineClass("Closure", "Closure30", [], {
 $call$1: function(request) {
  $.buildNavigation($.parse(request.get$responseText()));
 }
});

Isolate.$defineClass("Closure2", "Closure30", ["box_0"], {
 $call$2: function(k, v) {
...
Isolate.$defineClass("Closure3", "Closure30", ["box_0", "request_2"], {
 $call$1: function(e) {
...
Isolate.$defineClass("Closure4", "Closure30", ["box_0"], {
 $call$0: function() {
  return this.box_0.closure_1.$call$0();
 }
});

Isolate.$defineClass("Closure5", "Closure30", ["box_0"], {
 $call$0: function() {
  return this.box_0.closure_1.$call$1(this.box_0.arg1_2);
 }
});

Isolate.$defineClass("Closure6", "Closure30", ["box_0"], {
 $call$0: function() {
  return this.box_0.closure_1.$call$2(this.box_0.arg1_2, this.box_0.arg2_3);
 }
});

Isolate.$defineClass("Closure7", "Closure30", ["box_0"], {
 $call$1: function(e) {
  if ($.contains$1(this.box_0.pre_1.get$classes(), 'expanded') === true) {
    this.box_0.pre_1.get$classes().remove$1('expanded');
  } else {
...
Isolate.$defineClass("Closure8", "Closure30", [], {
 $call$1: function(n) {
  return typeof n === 'object' && n.is$Element();
 }
});

Isolate.$defineClass("Closure9", "Closure30", ["box_0", "output_2"], {
...
Isolate.$defineClass("Closure10", "Closure30", [], {
 $call$1: function(el) {
  return el.remove$0();
 }
});

Isolate.$defineClass("Closure11", "Closure30", ["this_0"], {
 $call$1: function(value) {
  this.this_0.add$1(value);
 }
});

Isolate.$defineClass("Closure12", "Closure30", ["box_0"], {
 $call$2: function(key, value) {
  this.box_0.f_12.$call$1(key);
 }
});

Isolate.$defineClass("Closure13", "Closure30", ["box_0"], {
 $call$2: function(key, value) {
  if (this.box_0.f_13.$call$1(key) === true) {
    $.add$1(this.box_0.result_2, key);
  }
 }
});

Isolate.$defineClass("Closure14", "Closure30", ["box_0"], {
 $call$1: function(s) {
  return $.add$1(s, this.box_0.value_1);
 }
});

Isolate.$defineClass("Closure15", "Closure30", ["box_0"], {
 $call$1: function(s) {
  return $.addAll(s, this.box_0.collection_1);
 }
});

Isolate.$defineClass("Closure16", "Closure30", [], {
 $call$1: function(s) {
  return $.clear(s);
 }
});

Isolate.$defineClass("Closure17", "Closure30", ["this_2", "box_0"], {
 $call$1: function(key) {
  return this.box_0.f_14.$call$2(key, $.index(this.this_2, key));
 }
});

Isolate.$defineClass("Closure18", "Closure30", ["this_1", "keys_0"], {
 $call$2: function(key, value) {
...
Isolate.$defineClass("Closure19", "Closure30", ["this_2", "box_0"], {
 $call$2: function(key, value) {
  if (this.this_2._matches$1(key) === true) {
    this.box_0.f_15.$call$2(this.this_2._strip$1(key), value);
  }
 }
});

Isolate.$defineClass("Closure20", "Closure30", ["box_0"], {
 $call$1: function(element) {
...
Isolate.$defineClass("Closure21", "Closure30", ["box_0"], {
 $call$1: function(entry) {
  this.box_0.f_16.$call$2(entry.get$key(), entry.get$value());
 }
});

Isolate.$defineClass("Closure22", "Closure30", [], {
 $call$2: function(a, b) {
  return $.compareTo(a, b);
 }
});

Isolate.$defineClass("Closure23", "Closure30", ["box_0"], {
 $call$2: function(icon, type) {
  $.add$1(this.box_0.html_1, '<li>');
  if ($.eqB($.currentType, $.index(type, 'name'))) {
    $.add$1(this.box_0.html_1, '<div class="icon-' + $.S(icon) + '"></div><strong>' + $.S($.index(type, 'name')) + '</strong>');
  } else {
    $.add$1(this.box_0.html_1, '          <a href="' + $.S($.prefix) + $.S($.index(type, 'url')) + '">\n            <div class="icon-' + $.S(icon) + '"></div>' + $.S($.index(type, 'name')) + '\n          </a>\n          ');
  }
  $.add$1(this.box_0.html_1, '</li>');
 }
});

Isolate.$defineClass("Closure24", "Closure30", ["writeType_2"], {
 $call$1: function(type) {
  return this.writeType_2.$call$2($.index(type, 'kind'), type);
 }
});

Isolate.$defineClass("Closure25", "Closure30", ["writeType_3"], {
 $call$1: function(type) {
  return this.writeType_3.$call$2('exception', type);
 }
});

Isolate.$defineClass("Closure26", "Closure30", ["keys_0"], {
 $call$2: function(k, v) {
  return $.add$1(this.keys_0, k);
 }
});

Isolate.$defineClass("Closure27", "Closure30", ["box_0"], {
 $call$2: function(key, value) {
...
Isolate.$defineClass("Closure28", "Closure30", ["box_0"], {
 $call$1: function(entry) {
...
$.stringReplaceAllUnchecked = function(receiver, from, to) {
  ...
  if (typeof from === 'string') {
    if (from === '') {
      ...
      return $.stringReplaceJS(receiver, $.regExpMakeNative($.JSSyntaxRegExp$3((from.replace($.regExpMakeNative($.CTC8, true), "\\$&")), false, false), true), to);
    }
  } else {
...
$.buildLibraryNavigation = function(html, library) {
  ...
  for (var t2 = $.iterator(library); t2.hasNext$0() === true; ) {
    var t3 = t2.next$0();
    if ($.endsWith($.index(t3, 'name'), 'Exception') === true) {
      $.add$1(exceptions, t3);
    } else {
      $.add$1(types, t3);
    }
...
$.buildNavigation = function(libraries) {
  if (typeof libraries !== 'string' && (typeof libraries !== 'object'||libraries.constructor !== Array)) return $.buildNavigation$bailout(libraries, 1, libraries);
  ...
  for (var t1 = $.iterator(libraryNames); t1.hasNext$0() === true; ) {
    ...
    if ($.eqB($.currentLibrary, t2) && $.eqNullB($.currentType)) {
      html.add$1('<strong>' + $.S($.escapeHtml(t2)) + '</strong>');
    } else {
      html.add$1('<a href="' + $.S($.prefix) + $.S($.sanitize(t2)) + '.html' + '">' + $.S($.escapeHtml(t2)) + '</a>');
    }
    html.add$1('</h2>');
...
$.classify = function(token) {
    ...
    case 65:
      return 'e';
    case 70:
      if ($._looksLikeType(token.get$text()) === true || $.eqB(token.get$text(), 'num') || $.eqB(token.get$text(), 'bool') || $.eqB(token.get$text(), 'int') || $.eqB(token.get$text(), 'double')) {
        return 't';
      }
      return 'i';
    case 115:
...
$.classifySource = function(src) {
  ...
  for (var inString = false; token = tokenizer.next$0(), !$.eqB(token.get$kind(), 1); ) {
    ...
    if (!$.eqNullB(kind)) {
      ...
      html.add$1('<span>' + $.S(text) + '</span>');
    }
    if ($.eqB(token.get$kind(), 58)) {
      inString = false;
    }
  }
...
$._hexDigit = function(c) {
  if ($.geB(c, 48) && $.leB(c, 57)) {
    return $.sub(c, 48);
  } else {
    if ($.geB(c, 97) && $.leB(c, 102)) {
      return $.sub(c, 87);
    } else {
      if ($.geB(c, 65) && $.leB(c, 70)) {
        return $.sub(c, 55);
      } else {
        return -1;
      }
...
$.CTC10 = new Isolate.$isolateProperties.ConstantMap(Isolate.$isolateProperties.CTC, {}, 0);
...
$.CTC8 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '[-[\\]{}()*+?.,\\\\^$|#\\s]');
...
$.$defineNativeClass('HTMLFieldSetElement', ["name?", "lib2$_FieldSetElementImpl$elements?"], {
 get$elements: function() {
...
$.$defineNativeClass('ShadowRoot', ["lib2$_ShadowRootImpl$innerHTML!"], {
